 ...
 */
type TstoredData = { id: string, email: string, phone?: string }

/**
 * Sign a JWT Token
 * @param {Object} user
 */
export function sign(user: TstoredData): Promise<string | undefined> {
 ...
 * @param {Object} user
 */
export function verify(token: string): Promise<TstoredData | null> {
  // Step 1: Promise wrapper
